...
\begin{itemize}
    ...
    \item \textbf{Datos autodeclarados}: variables como la calidad del sueño, el nivel de estrés o la duración del sueño están basadas en percepciones subjetivas del paciente, introduciendoo sesgos de respuesta.
